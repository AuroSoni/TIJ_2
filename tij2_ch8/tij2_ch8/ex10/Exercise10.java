...
class Component1{
    ...
    Component1(String name){
        custom_tools.print.Print.print("Component1()");
        cno=1;
        cname=name;
    }
    String print(){
...
class Component2{
    ...
    Component2(String name){
        custom_tools.print.Print.print("Component2()");
        cno=2;
        cname=name;
    }
    String print(){
...
class Component3{
    ...
    Component3(String name){
        custom_tools.print.Print.print("Component3()");
        cno=3;
        cname=name;
    }
    String print(){
...
class Root{
    ...
    Root(String name1,String name2, String name3){
        custom_tools.print.Print.print("Root()");
...
public class Exercise10 extends Root{
    ...
    public Exercise10(String name1,String name2, String name3,String namea, String nameb,String namec){
        ...
        custom_tools.print.Print.print("Exercise9()");
